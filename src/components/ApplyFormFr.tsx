...
const ApplyFormFr = ({
  ...
  const openNotification = () => {
    api.open({
      ...
      description:
        "Nous vous répondrons dans les plus brefs délais. Merci pour votre intérêt !",
      showProgress: true,
      pauseOnHover: true,
    });
  };
  ...
  return (
    <div className="">
      {contextHolder}
      <h2 className="cp-title cp_responsive text-center">
        Demander l&apos;accès
      </h2>
      ...
      >
        <div className="cp-short-description cp_responsive cp-clear mb-6 text-center">
          Envoyez le formulaire ci-dessous pour nous contacter
        </div>
      </div>
      <Form
        autoComplete="on"
